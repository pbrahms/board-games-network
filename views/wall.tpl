...
<div class="dashLeft">
    <div class="card">
        <div><img class="dashHeadProfImg dashlink" src="images/{$sessionuserimage}"></div>
            <div><a class="dashLink" href="wall.php?username={$postrows[i].username}">{$firstname} {$lastname}</a></div><br>
...
<div class="dashCenter">
    {if $sessionusername == $getusername}
    ...
    <div>
        <form action="wall.php?username={$getusername}" enctype="multipart/form-data"  method="post"><br/>
    ...
    <section class="dashPosts"> 
        ...
        <div>
            <a class="dashLink" href="wall.php?username={$getusername}">
