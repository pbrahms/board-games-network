<?php
/* Smarty version 3.1.33, created on 2019-04-08 18:47:23
  from '/storage/ssd4/869/9207869/public_html/board-games-network/views/wall.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5cab973b0d7661_79006882',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '9f921d9b97cea23df2288d7775e827a4f895c3be' => 
    array (
      0 => '/storage/ssd4/869/9207869/public_html/board-games-network/views/wall.tpl',
      1 => 1554749209,
      2 => 'file',
    ),
  ),
...
function content_5cab973b0d7661_79006882 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html>
<head>
    <title>Wall</title>
...
<div class="dashLeft">
    <div class="card">
        <div><img class="dashHeadProfImg dashlink" src="images/<?php echo $_smarty_tpl->tpl_vars['sessionuserimage']->value;?>
"></div>
            <div><a class="dashLink" href="wall.php?username=<?php echo $_smarty_tpl->tpl_vars['postrows']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_i']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_i']->value['index'] : null)]['username'];?>
"><?php echo $_smarty_tpl->tpl_vars['firstname']->value;?>
 <?php echo $_smarty_tpl->tpl_vars['lastname']->value;?>
            ...
            <div style="margin: 24px 0;">
                <a class="linkovi" href="#"><i class="fa fa-dribbble"></i></a> 
                <a class="linkovi" href="#"><i class="fa fa-twitter"></i></a>  
                <a class="linkovi" href="#"><i class="fa fa-linkedin"></i></a>  
                <a class="linkovi" href="#"><i class="fa fa-facebook"></i></a><br><br>
                <button class="leviKlik">Contact</button>
            </div>
    </div>
</div>
<!-- end left div-->

    <!-- open center div - for posts-->



<!-- CENTER DIV -->
<div class="dashCenter">
    <?php if ($_smarty_tpl->tpl_vars['sessionusername']->value == $_smarty_tpl->tpl_vars['getusername']->value) {?>
...
">
    ...
    <div>
        <form action="wall.php?username=<?php echo $_smarty_tpl->tpl_vars['getusername']->value;?>
...
">
        ...
        <div>
            <a class="dashLink" href="wall.php?username=<?php echo $_smarty_tpl->tpl_vars['getusername']->value;?>
">
   ...
   if ( window.history.replaceState ) {
    ...
    function listComments(niz){
        ...
        for(var i in niz){
            ...
            el.innerHTML+='<div class="stilCommImg"><img id="postuserimageInComm" class="commProfImg" src="images/'+niz[i].userimage+'"></div><div class="stilCommBody"><a class="dashLink" href="wall.php?username='+niz[i].userid+'"><span id="postfirstnameInComm" style="color: black" >'+niz[i].firstname+' '+'</span><span id="postlastnameInComm" style="color: black">'+niz[i].lastname+'</span></a><br/><p id="postbodyInComm" style="color: black">'+niz[i].commentbody+'</p><p>'+niz[i].commentdate+'</p><div style="display:block"><div style="height: 5px; overflow: hidden; width: 100%;"></div><hr style="width:100%;"><div style="height: 5px; overflow: hidden; width: 100%;"></div></div></div>'
        }
