...
if(!empty($_POST["submitpost"])) {
	...
	$sqlinsert = "INSERT INTO posts(postid, postbody, postdate, userid, image, privacy) VALUES (null, '".$postbody."', now(), '".$userid."','".$targetImg."', '".$privacy."')";
...
if(!empty($_POST["submitComment"])){
	...
	$sqlInsertComment = "INSERT INTO comments(commentid, commentbody, commentdate, userid, postid) VALUES (null, '".$commentbody."', now(), '".$userid."','".$postid."')";
